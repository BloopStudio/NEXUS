...
const STRINGS := {
	...
	"menu.lan_label": {"en": "Games found on this network:", "fr": "Parties détectées sur ce réseau :", "es": "Partidas detectadas en esta red:", "de": "Auf diesem Netzwerk gefundene Spiele:", "it": "Partite trovate su questa rete:", "pt": "Jogos encontrados nesta rede:", "ru": "Игры, найденные в этой сети:", "ja": "このネットワークで見つかったゲーム：", "zh": "在此网络中找到的游戏：", "ar": "الألعاب الموجودة على هذه الشبكة:"},
	"menu.lan_empty": {"en": "No games found yet on this network…", "fr": "Aucune partie détectée sur ce réseau pour l'instant…", "es": "Aún no se ha detectado ninguna partida en esta red…", "de": "Bisher keine Spiele in diesem Netzwerk gefunden…", "it": "Nessuna partita trovata su questa rete per ora…", "pt": "Ainda não foi encontrado nenhum jogo nesta rede…", "ru": "Пока не найдено ни одной игры в этой сети…", "ja": "このネットワークではまだゲームが見つかりません…", "zh": "此网络中尚未发现任何游戏…", "ar": "لم يتم العثور على أي مباراة بعد على هذه الشبكة…"},
	"menu.lan_join": {"en": "Join", "fr": "Rejoindre", "es": "Unirse", "de": "Beitreten", "it": "Unisciti", "pt": "Entrar", "ru": "Войти", "ja": "参加", "zh": "加入", "ar": "انضمام"},
